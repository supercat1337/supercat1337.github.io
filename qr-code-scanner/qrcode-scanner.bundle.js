...
var QRScanner = class {
  ...
  scanQRCode(img) {
    ...
    try {
      const code = (0, import_jsQR.default)(
        imageData.data,
        imageData.width,
        imageData.height,
        {
  ...
  displayQRCodeArea(location, originalImg) {
    ...
    const padding = 10;
    const qrWidth = location.bottomRightCorner.x - location.topLeftCorner.x + padding * 2;
    const qrHeight = location.bottomRightCorner.y - location.topLeftCorner.y + padding * 2;
